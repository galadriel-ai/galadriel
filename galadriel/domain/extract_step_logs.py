...
async def pull_messages_from_step(
    ...
    if isinstance(step_log, ActionStep):
        ...
        yield Message(
            content=f"**{step_number}**", conversation_id=conversation_id, additional_kwargs=additional_kwargs
        )
        ...
        if hasattr(step_log, "tool_calls") and step_log.tool_calls is not None:
            ...
            if hasattr(step_log, "error") and step_log.error is not None:
                ...
                yield Message(
                    content=str(step_log.error), conversation_id=conversation_id, additional_kwargs=error_kwargs
                )
